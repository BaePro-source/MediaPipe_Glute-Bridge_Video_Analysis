...
from model import build_resnet152
...
def run_fold(fold_idx, train_subjects, val_subjects, test_subjects):
    ...
    model     = build_resnet152(pretrained=True).to(DEVICE)
    ...
    for epoch in range(EPOCHS):
        ...
        # best model 저장 + early stopping: val macro-F1 기준
